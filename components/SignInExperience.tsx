...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#111' }, background: { flex: 1, justifyContent: 'space-between' }, splitBackground: { ...StyleSheet.absoluteFill, flexDirection: 'row' }, splitPanel: { flex: 1 }, mobileBackground: { ...StyleSheet.absoluteFill }, overlay: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(0,0,0,0.63)' }, top: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 24 }, wordmark: { color: '#fff', fontSize: 13, fontWeight: '700', letterSpacing: 2 },
  copy: { paddingHorizontal: 24, marginTop: 'auto', marginBottom: 34 }, caps: { color: '#fff', opacity: 0.78 }, title: { color: '#fff', fontSize: 43, lineHeight: 44, fontWeight: '600', letterSpacing: -1.8, marginTop: 10 }, body: { color: '#fff', opacity: 0.84, fontSize: 14, lineHeight: 21, maxWidth: 315, marginTop: 15 },
  bottom: { paddingHorizontal: 24 }, prompt: { color: '#fff', opacity: 0.68, fontSize: 10, fontWeight: '700', letterSpacing: 1.8, textAlign: 'center', marginBottom: 14 }, actions: { flexDirection: 'row', justifyContent: 'center', gap: 15 }, action: { width: 72, height: 72, borderRadius: 36, borderWidth: 1, borderColor: '#FFFFFF99', alignItems: 'center', justifyContent: 'center', backgroundColor: '#00000035' }, apple: { color: '#fff', fontSize: 31, lineHeight: 34 }, google: { color: '#fff', fontSize: 25, fontWeight: '700' }, email: { color: '#fff', fontSize: 25 }, legal: { color: '#fff', opacity: 0.68, fontSize: 11, lineHeight: 17, textAlign: 'center', marginTop: 23 },
});
